...
class SnackBarRoute<T> extends OverlayRoute<T> {
  ...
  final OnSnackBarStatusChanged _onStatusChanged;
  ...
  SnackBarRoute(
      ...
      : _builder = Builder(builder: (BuildContext innerContext) {
        ...
        _onStatusChanged = customSnackBar.onStatusChanged,
  ...
  void _configureTimer() {
    if (customSnackBar.duration != null) {
  ...
  Widget _getDismissibleWidget(
    ...
    for (final direction in dismissDirections) {
      childWidget = Dismissible(
        ...
        direction: direction,
        confirmDismiss: (_) {
          if (currentStatus == CustomSnackBarStatus.isAppearing ||
              currentStatus == CustomSnackBarStatus.isHiding) {
...
SnackBarRoute showSnackBar<U>(
    {@required BuildContext context, @required CustomSnackBar customSnackBar}) {
  assert(customSnackBar != null, AssertionConstants.customSnackBarNotNull);

  return SnackBarRoute<U>(
      customSnackBar: customSnackBar,
      theme: Theme.of(context),
      settings: const RouteSettings(name: customSnackBarRoute));
}
